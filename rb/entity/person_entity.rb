# FootballData SDK Person entity
...
class PersonEntity
  ...
  # @return [Person, Hash] the loaded Person; raises FootballDataError on failure
  ...
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Person>, Array] the matching Person items; raises FootballDataError on failure
