...
func (sdk *FootballDataSDK) OptionsMap() map[string]any {
...
func (sdk *FootballDataSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *FootballDataSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *FootballDataSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *FootballDataSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *FootballDataSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *FootballDataSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("FootballDataSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *FootballDataSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *FootballDataSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("FootballDataSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *FootballDataSDK {
	...
	sdk := NewFootballDataSDK(sdkopts)
	sdk.Mode = "test"
