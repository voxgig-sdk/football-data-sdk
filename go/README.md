...
## Install
```bash
go get github.com/voxgig-sdk/football-data-sdk
```
...
```bash
go mod edit -replace github.com/voxgig-sdk/football-data-sdk=../path/to/github.com/voxgig-sdk/football-data-sdk
```
...
```
github.com/voxgig-sdk/football-data-sdk/
...
The root package (`github.com/voxgig-sdk/football-data-sdk`) re-exports everything needed
