...
func TestMatchEntity(t *testing.T) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		matchRef01DataDt0LoadResult := core.ToMapAny(entityData(matchRef01DataDt0Loaded))
...
func matchBasicSetup(extra map[string]any) *entityTestSetup {
	...
	entidEnvRaw := os.Getenv("FOOTBALL_DATA_TEST_MATCH_ENTID")
	...
	idmapResolved := core.ToMapAny(env["FOOTBALL_DATA_TEST_MATCH_ENTID"])
