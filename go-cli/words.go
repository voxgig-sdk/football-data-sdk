...
func registerSDKWords(r *eng.Registry, client *sdk.FootballDataSDK) {
...
func runOp(client *sdk.FootballDataSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
