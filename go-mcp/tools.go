...
type Args struct {
	Entity string         `json:"entity" jsonschema:"area | competition | match | person | team"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.FootballDataSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "football-data_list",
		Description: "List records from FootballData. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "football-data_load",
		Description: "Load a single record from FootballData. " +
...
func runOp(client *sdk.FootballDataSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.FootballDataSDK, name string) (sdk.FootballDataEntity, error) {
