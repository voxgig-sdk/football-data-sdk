// Command FootballData-mcp is an MCP server exposing the FootballData
// SDK as MCP tools.
//
// Two tools are registered:
//
//	FootballData_list  — list records of an entity
//	FootballData_load  — load a single record of an entity
//
