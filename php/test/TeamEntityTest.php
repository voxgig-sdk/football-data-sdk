...
class TeamEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set FOOTBALLDATA_TEST_TEAM_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function team_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("FOOTBALLDATA_TEST_TEAM_ENTID");
