...
// FootballData SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (FootballDataSDK::test)
...
{
    private const SDK_CLASS = 'FootballDataSDK';
    ...
    private const SDK_BASE = 'footballdata_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../footballdata_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
