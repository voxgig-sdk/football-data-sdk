...
class FootballDataTestRunner
{
    ...
    {
        $live = self::getenv('FOOTBALL_DATA_TEST_LIVE');
        $override = self::getenv('FOOTBALL_DATA_TEST_OVERRIDE');
        ...
        $explain = self::getenv('FOOTBALL_DATA_TEST_EXPLAIN');
...
class_alias('FootballDataTestRunner', 'Runner');
class_alias('FootballDataHelpers', 'Helpers');
