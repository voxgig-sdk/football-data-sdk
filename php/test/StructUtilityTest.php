...
// FootballData SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = FootballDataOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(FootballDataOmni::structfix($now, Struct::undef()))
                        !== json_encode(FootballDataOmni::structfix($val, Struct::undef()))) {
