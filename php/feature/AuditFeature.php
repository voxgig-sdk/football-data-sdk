...
// FootballData SDK audit feature
...
class FootballDataAuditFeature extends FootballDataBaseFeature
{
    ...
    private function _emit(FootballDataContext $ctx, string $outcome): void
    {
