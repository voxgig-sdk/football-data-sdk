...
// FootballData SDK ratelimit feature
...
class FootballDataRatelimitFeature extends FootballDataBaseFeature
{
    ...
    private function _acquire(FootballDataContext $ctx): void
    {
    ...
    private function _track(FootballDataContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
