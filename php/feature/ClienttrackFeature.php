...
// FootballData SDK clienttrack feature
...
class FootballDataClienttrackFeature extends FootballDataBaseFeature
{
    ...
    public function PostConstruct(FootballDataContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'FootballData-SDK';
