...
// FootballData SDK metrics feature
...
class FootballDataMetricsFeature extends FootballDataBaseFeature
{
    ...
    private function _record(FootballDataContext $ctx, bool $ok): void
    {
