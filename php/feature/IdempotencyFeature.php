...
// FootballData SDK idempotency feature
...
class FootballDataIdempotencyFeature extends FootballDataBaseFeature
{
    ...
    private function _mutating(FootballDataContext $ctx): bool
    {
