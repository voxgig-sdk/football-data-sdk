...
// FootballData SDK proxy feature
...
class FootballDataProxyFeature extends FootballDataBaseFeature
{
    ...
    public function init(FootballDataContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (FootballDataContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
