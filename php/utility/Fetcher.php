...
// FootballData SDK utility: fetcher
...
class FootballDataFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; FootballDataSDK/1.0)';
    ...
    public static function call(FootballDataContext $ctx, string $fullurl, array $fetchdef): array
    {
