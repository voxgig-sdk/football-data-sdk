...
// FootballData SDK utility: make_options

class FootballDataMakeOptions
{
    ...
    public static function call(FootballDataContext $ctx): array
    {
        ...
        //
        // `FootballDataSchema::optspec()` is built from the model:
        ...
        $optspec = FootballDataSchema::optspec();
