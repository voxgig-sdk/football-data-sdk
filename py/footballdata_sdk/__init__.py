...
from footballdata_sdk.utility import register

# Load features
from footballdata_sdk.feature.base_feature import FootballDataBaseFeature
from footballdata_sdk.features import _has_feature, _make_feature
...
class FootballDataSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = FootballDataUtility()
        self._utility = utility

        from footballdata_sdk.config import shared_config
    ...
    def get_utility(self):
        return FootballDataUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("FootballDataSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Area(self, data=None) -> "AreaEntity":
        ...
        from footballdata_sdk.entity.area_entity import AreaEntity
    ...
    def Competition(self, data=None) -> "CompetitionEntity":
        ...
        from footballdata_sdk.entity.competition_entity import CompetitionEntity
    ...
    def Match(self, data=None) -> "MatchEntity":
        ...
        from footballdata_sdk.entity.match_entity import MatchEntity
    ...
    def Person(self, data=None) -> "PersonEntity":
        ...
        from footballdata_sdk.entity.person_entity import PersonEntity
        return PersonEntity(self, data)


    def Team(self, data=None) -> "TeamEntity":
        """Entity factory: client.Team().list() / client.Team().load({"id": ...})."""
        from footballdata_sdk.entity.team_entity import TeamEntity
