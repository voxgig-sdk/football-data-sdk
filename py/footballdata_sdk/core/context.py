...
from footballdata_sdk.core.helpers import get_ctx_prop, to_map
...
class FootballDataContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(sp, FootballDataSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, FootballDataResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, FootballDataResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return FootballDataError(code, msg, self)
