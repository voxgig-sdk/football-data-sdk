    ...
    def test_should_run_basic_flow(self):
        ...
        if setup.get("synthetic_only"):
            pytest.skip("live entity test uses synthetic IDs from fixture — "
                        "set FOOTBALL_DATA_TEST_MATCH_ENTID JSON to run live")
        client = setup["client"]
        ...
        match_ref01_data_dt0_load_result = helpers.to_map(runner.entity_data(match_ref01_data_dt0_loaded))
...
def _match_basic_setup(extra):
    ...
    idmap_resolved = helpers.to_map(
        env.get("FOOTBALL_DATA_TEST_MATCH_ENTID"))
    ...
    _live = env.get("FOOTBALL_DATA_TEST_LIVE") == "TRUE"
    return {
        "client": client,
        "data": entity_data,
        "idmap": idmap_resolved,
        "env": env,
        "explain": env.get("FOOTBALL_DATA_TEST_EXPLAIN") == "TRUE",
        "live": _live,
