# FootballData SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions FootballDataSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both FootballDataSDK(...) and FootballDataSDK.test(...) become
#      FootballDataSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "footballdata_sdk"
_SDK_CLASS = "FootballDataSDK"
