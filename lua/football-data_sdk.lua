...
local FootballDataSDK = {}
FootballDataSDK.__index = FootballDataSDK
...
FootballDataSDK._make_feature = _make_feature


function FootballDataSDK.new(options)
  local self = setmetatable({}, FootballDataSDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function FootballDataSDK:options_map()
...
function FootballDataSDK:get_utility()
  return Utility.copy(self._utility)
end


function FootballDataSDK:get_root_ctx()
  return self._rootctx
end


function FootballDataSDK:prepare(fetchargs)
...
function FootballDataSDK:direct(fetchargs)
...
-- by passing it.
function FootballDataSDK:_raw_request(fetchargs)
  local utility = self._utility
...
function FootballDataSDK:graphql(query, variables, ctrl)
  ...
  if type(errors) == "table" and 0 < #errors then
    ...
    res.ok = false
    res.err = "FootballDataSDK: graphql: " .. msg
    res.graphql = errors
  end
...
function FootballDataSDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
  ...
  local sdk = FootballDataSDK.new(sdkopts)
  sdk.mode = "test"
