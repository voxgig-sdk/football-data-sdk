...
local SDK_MODULE = "football-data_sdk"
...
-- data to return.
local TEST_SEED = '{ entity = { ["area"] = { ["test01"] = { id = "test01" } }, ["competition"] = { ["test01"] = { id = "test01" } }, ["match"] = { ["test01"] = { id = "test01" } }, ["person"] = { ["test01"] = { id = "test01" } }, ["team"] = { ["test01"] = { id = "test01" } } } }'
