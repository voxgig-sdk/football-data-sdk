...
function runner.env_override(m)
  local live = runner.getenv("FOOTBALLDATA_TEST_LIVE")
  local override = runner.getenv("FOOTBALLDATA_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("FOOTBALLDATA_TEST_EXPLAIN")
