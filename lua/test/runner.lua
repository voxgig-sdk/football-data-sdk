...
function runner.env_override(m)
  local live = runner.getenv("FOOTBALL_DATA_TEST_LIVE")
  local override = runner.getenv("FOOTBALL_DATA_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("FOOTBALL_DATA_TEST_EXPLAIN")
