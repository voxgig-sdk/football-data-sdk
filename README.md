...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/football-data` | `npm install @voxgig-sdk/football-data` |
| Python | `voxgig-sdk-football-data` | `pip install voxgig-sdk-football-data` |
| PHP | `voxgig-sdk/football-data` | `composer require voxgig-sdk/football-data` |
| Golang | `github.com/voxgig-sdk/football-data-sdk/go` | `go get github.com/voxgig-sdk/football-data-sdk/go` |
| Ruby | `voxgig-sdk-football-data` | `gem install voxgig-sdk-football-data` |
| Lua | `voxgig-sdk-football-data` | `luarocks install voxgig-sdk-football-data` |
