...
The Football Data API provides comprehensive access to football (soccer) statistics and information.

Learn more about Football Data API at [football-data.org](http://football-data.org).
...
This SDK exposes the API as a small set of **semantic entities** — Area, Competition, Match, Person and Team — that you
