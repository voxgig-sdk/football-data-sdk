...
// FootballData SDK cache feature
...
class FootballDataCacheFeature extends FootballDataBaseFeature
{
    ...
    private function _through(FootballDataContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
