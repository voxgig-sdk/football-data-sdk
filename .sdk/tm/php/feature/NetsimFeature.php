...
// FootballData SDK netsim feature
...
class FootballDataNetsimFeature extends FootballDataBaseFeature
{
    ...
    private function _simulate(FootballDataContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(FootballDataContext $ctx, array $applied): void
    {
        $client = $this->client;
