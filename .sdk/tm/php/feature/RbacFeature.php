...
class FootballDataRbacFeature extends FootballDataBaseFeature
{
    ...
    private function _required(FootballDataContext $ctx): ?string
    {
    ...
    private function _reject(FootballDataContext $ctx, string $required): void
    {
    ...
    private function _track(FootballDataContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
