...
// FootballData SDK streaming feature
...
class FootballDataStreamingFeature extends FootballDataBaseFeature
{
    ...
    private function _iterate(FootballDataResult $result): \Generator
    {
    ...
    private function _streamable(FootballDataContext $ctx): bool
    {
