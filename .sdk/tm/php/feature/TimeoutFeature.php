...
// FootballData SDK timeout feature
...
class FootballDataTimeoutFeature extends FootballDataBaseFeature
{
    ...
    private function _with_timeout(FootballDataContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(FootballDataContext $_ctx, float $ms): void
    {
        $client = $this->client;
