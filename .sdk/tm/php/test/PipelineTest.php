...
// FootballData SDK pipeline test
//
...
{
    private static function utility(): FootballDataUtility
    {
        return new FootballDataUtility();
    }
    ...
    private static function ctx(array $over = []): FootballDataContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new FootballDataContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new FootballDataOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof FootballDataError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new FootballDataOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = FootballDataMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new FootballDataOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = FootballDataMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new FootballDataOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = FootballDataMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new FootballDataSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = FootballDataMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new FootballDataResponse([]),
            'result' => new FootballDataResult([]),
        ]);
        [, $err] = FootballDataMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new FootballDataSpec([]),
            'response' => null,
            'result' => new FootballDataResult([]),
        ]);
        [, $err] = FootballDataMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new FootballDataSpec(['step' => 's']),
            'response' => new FootballDataResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new FootballDataResult([]),
        ]);
        [, $err] = FootballDataMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new FootballDataSpec(['step' => 's']),
            'response' => new FootballDataResponse(self::resp(200, ['v' => 1])),
            'result' => new FootballDataResult([]),
        ]);
        [, $err] = FootballDataMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new FootballDataSpec(['step' => 's']),
            'response' => new FootballDataResponse(self::resp(200, ['v' => 2])),
            'result' => new FootballDataResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        FootballDataMakeResponse::call($ctx);
    ...
    {
        $preset = new FootballDataResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new FootballDataSpec([]),
            'response' => new FootballDataResponse([]),
            'result' => new FootballDataResult([]),
        ...
        [$got, $err] = FootballDataMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new FootballDataResult([])]);
        [, $err] = FootballDataMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new FootballDataSpec([]), 'result' => null]);
        [, $err] = FootballDataMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new FootballDataSpec(['step' => 's']),
            'result' => new FootballDataResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new FootballDataOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = FootballDataMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new FootballDataSpec(['step' => 's']),
            'result' => new FootballDataResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new FootballDataOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = FootballDataMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new FootballDataResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new FootballDataSpec([]),
            'result' => new FootballDataResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = FootballDataMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = FootballDataMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new FootballDataError('boom', 'boom');
        $utility->fetcher = function (FootballDataContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new FootballDataSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = FootballDataMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (FootballDataContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = FootballDataMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(FootballDataResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        FootballDataMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (FootballDataContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new FootballDataSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = FootballDataMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new FootballDataResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new FootballDataSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = FootballDataMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = FootballDataMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = FootballDataMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new FootballDataResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, FootballDataDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new FootballDataResult(['ok' => false])]);
        $this->expectException(FootballDataError::class);
        FootballDataDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new FootballDataResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', FootballDataMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        FootballDataMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new FootballDataBaseFeature();
        $b = new FootballDataBaseFeature();
        FootballDataFeatureAdd::call($ctx, $a);
        FootballDataFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): FootballDataBaseFeature
    {
        $f = new FootballDataBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        FootballDataFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): FootballDataContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new FootballDataSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = FootballDataPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        FootballDataPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new FootballDataResponse(['headers' => null]),
            'result' => new FootballDataResult([]),
        ]);
        FootballDataResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        FootballDataResultBody::call($ctx);
