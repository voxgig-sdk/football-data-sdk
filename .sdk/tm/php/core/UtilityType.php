...
// FootballData SDK utility type

class FootballDataUtility
{
    ...
    public static function copy(FootballDataUtility $src): FootballDataUtility
    {
        $u = new FootballDataUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
