...
// FootballData SDK utility: graphql
//
...
class FootballDataGraphql
{
    ...
    // equivalent.
    public static function body(FootballDataContext $ctx): mixed
    {
    ...
    public static function errors(FootballDataContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
