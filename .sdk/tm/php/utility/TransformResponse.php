...
// FootballData SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class FootballDataTransformResponse
{
    public static function call(FootballDataContext $ctx): mixed
    {
        ...
        $transform = FootballDataHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
