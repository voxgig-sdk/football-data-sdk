...
def make_error_util(ctx, err):
    if ctx is None:
        from projectname_sdk.core.context import FootballDataContext
        ctx = FootballDataContext({}, None)
    ...
    errmsg = ""
    if isinstance(err, FootballDataError):
        errmsg = err.msg
    ...
    sdk_err = FootballDataError("", msg, ctx)
