...
|---|---|---|
| `ts/` | @voxgig-sdk/football-data-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/football-data-sdk \
      --repository voxgig-sdk/football-data-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/football-data-sdk` shows it, and
`npm trust revoke @voxgig-sdk/football-data-sdk --id=<id>` removes it.
